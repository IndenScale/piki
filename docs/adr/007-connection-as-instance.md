...
1. **内嵌，不独立**：Interface 依附于 Instance，不作为独立 Instance。和 ADR-006 "引用而非嵌入" 策略一脉相承——Instance 声明自己有什么接口，但不负责连接逻辑。
...
- [ADR-006: CAD 资产引用](006-cad-asset-reference.md)
