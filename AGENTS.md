...
- **Mating**（ADR-006）：物理配合关系（"rack-mount-19inch"，"IEC-C14-C13 电源配对"）
...
- **L1 机械配合**：rack-mount、螺栓孔、卡扣
- **L2 接口配合**：IEC-C14-C13 电源配对、SFP28 笼子 → 光模块
- **L3 跨装配链路**：跨配合组件的 Connection 链

Mate 的 `constrains` 在引擎加载时自动验证。
